...
public class DatabasePresenter {
    ...
    public void onInit(int mode,Song song){
        if(mode==1){
            databaseInterface.onView(View.VISIBLE,View.VISIBLE,View.GONE,song.getSinger(),song.getName(),song.getImage());
        }else if(mode == 2){
            databaseInterface.onView(View.GONE,View.GONE,View.VISIBLE,song.getSinger(),song.getName(),song.getImage());
